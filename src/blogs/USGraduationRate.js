...
function USGraduationRate() {
  const [institutions, setInstitutions] = useState([]);
  const [search, setSearch] = useState("");
  const [suggestions, setSuggestions] = useState([]);
  const [flyTarget, setFlyTarget] = useState(null);

  const pageUrl = "https://www.lopezbio.com/blogs/us-graduation-rate";
  ...
  return (
    <div className="blog-article">
      <Helmet>
        ...
        <meta name="description" content="An interactive map showing U.S. 4-year college graduation rates, helping families make informed college choices." />
        <meta property="og:title" content={pageTitle} />
        <meta property="og:description" content="Explore graduation rates with this interactive college map built by a father for his son—and other families." />
        <meta property="og:url" content={pageUrl} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={pageTitle} />
        <meta name="twitter:description" content="Interactive graduation rate map for college planning decisions." />
      </Helmet>
      ...
      <div className="blog-body">
        <p>
          This project started with a deeply personal purpose: helping my son navigate one of the biggest decisions of his life — choosing the right college. As a father and technologist, I wanted to do more than offer encouragement. I wanted to give him insight, backed by real data.
        </p>
        <p>
          I began by exploring national graduation statistics, eventually building dashboards in Power BI. But I wanted something more interactive, more visual — something he could explore himself. That’s when I decided to build this application from scratch using React, Leaflet, and live CSV parsing.
        </p>
        <p>
          This interactive map visualizes 4-year graduation rates for institutions across the United States. Green circles show strong graduation rates (80%+), orange means average (40%–79%), and red shows fewer than 40% of students finishing on time. Hover over any dot to see details.
        </p>
        <p>
          I hope this tool empowers other families to make confident decisions, and helps counselors and students look beyond brand names toward real student outcomes.
        </p>
      </div>
      ...
      <div className="blog-citations">
        <h3>Data Source</h3>
        <p>
          U.S. Department of Education, College Scorecard, updated April 23, 2025.{" "}
          <a
...
export default USGraduationRate;
