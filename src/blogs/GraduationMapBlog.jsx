    ...
    Papa.parse("/data/cleaned_graduation_data.csv", {
      ...
      complete: (results) => {
        const parsed = results.data.filter(row =>
          row.LATITUDE && row.LONGITUDE && row.C150_4
        ).map(row => ({
          name: row.INSTNM,
          city: row.CITY,
          state: row.STABBR,
    ...
    <div className="blog-article">
      ...
      <div className="blog-title-block">
        ...
        <MapContainer
            ...
            style={{ height: "600px", width: "100%", margin: "2rem 0" }}
        >
      ...
      <div className="blog-body">
        ...
        <div className="blog-citations" style={{ marginTop: "2rem" }}>
          <h3>Works Cited</h3>
          <p>
            U.S. Department of Education. <em>College Scorecard Data Home</em>. Data last updated April 23, 2025.  
            <br />
